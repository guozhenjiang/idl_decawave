...
#define GPIO_ResetBits(x,y)             HAL_GPIO_WritePin(x,y, GPIO_PIN_RESET)  //HAL_GPIO_WritePin(x,y, RESET)
#define GPIO_SetBits(x,y)               HAL_GPIO_WritePin(x,y, GPIO_PIN_SET)    //HAL_GPIO_WritePin(x,y, SET)
